...
**Anthropicの1兆ドル到達の構造解剖 / Decoding the $1T Trajectory**
...
確定値は、2026年2月12日のシリーズGラウンドにおける**3,800億ドル**のポストマネー評価額である。そして、シリーズGの時点で140億ドルだったARR（年間経常収益）は、2ヶ月足らずで300億ドルを超えた。ダリオ・アモディは「年間10倍成長を計画していたのに、80倍を見た」と語った。

本書の問いは明快だ。**なぜこの軌道が成立したのか。**

通常の企業評価は、収益・利益・成長率といった財務指標から算出される。だがAnthropicの場合、これらの指標は軌道を「説明」するが「予測」しない。**Anthropicという企業の構造そのものに対する市場の判定**を、6つのレイヤー——軌道の事実、製品エンジン+物理基盤、思想と信頼、フロンティアラボ比較、組織・資本、地理的展開——から解剖する。

判定ではない。優劣の比較ではない。「Anthropicが勝った」のような表現は本書では一度も使わない。**観測可能な事実から構造を記述する**ことが本書の目的である。
...
Issues and Pull Requests are welcome. 本書の構造分析に対するフィードバック、Anthropicおよびフロンティアラボ各社の最新動向の追加情報、誤字脱字の修正など、皆様からのContributeを歓迎します。
